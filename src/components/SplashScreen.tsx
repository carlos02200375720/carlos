...
import { Sparkles, RefreshCw, Server, Wifi, ArrowRight } from "lucide-react";
    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 z-50 flex flex-col items-center justify-between p-6 bg-black text-white select-none overflow-hidden"
          style={{
          ...
          <div className="flex flex-col items-center justify-center text-center max-w-sm w-full relative z-10 my-auto">
            ...
            <div className="relative mb-8">
              ...
              <motion.div
                ...
                className="absolute -inset-4 rounded-3xl bg-gradient-to-tr from-purple-600 via-pink-500 to-amber-400 opacity-40 blur-lg"
              />

              {/* App Icon Image with subtle float */}
              <motion.div
                animate={{ y: [0, -6, 0] }}
                transition={{
                  repeat: Infinity,
