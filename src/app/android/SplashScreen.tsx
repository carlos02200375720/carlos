...
export default function AndroidSplashScreen({
  ...
  return (
    <div
      ...
      className={`fixed inset-0 z-50 flex flex-col items-center justify-between p-6 bg-slate-950 text-white select-none overflow-hidden font-sans transition-all duration-400 ease-in-out ${
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center text-center max-w-sm w-full relative z-10 my-auto">
        <div className="relative mb-6">
          <div className="absolute -inset-4 bg-amber-500/20 rounded-3xl blur-xl animate-pulse" />
        ...
        <div className="mt-8 w-full max-w-xs flex flex-col items-center">
          ...
          <div className="w-full h-1 bg-slate-800 rounded-full overflow-hidden relative">
            <div className="w-1/2 h-full bg-gradient-to-r from-amber-500 to-amber-300 rounded-full animate-pulse" />
          </div>
        </div>
